"""
FactoryIQ: Smart Factory & Industry 4.0 Equipment Effectiveness (OEE) Analytics - Synthetic Telemetry Data Generator
"""
import argparse
import datetime
import os
...
def generate_dataset(n_records=10000, output_dir="data"):
    ...
    print(f"Generating {n_records} records for FactoryIQ-Industry40-Manufacturing-OEE-Analytics...")
    records = []
