...
## 🏢 Platform: FactoryIQ: Smart Factory & Industry 4.0 Equipment Effectiveness (OEE) Analytics
**Schema**: `factoryiq_dw`  
...
### 2. `dim_machines_cnc`
Dimensional attribute master for Machines Cnc.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `machines_cnc_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `machines_cnc_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_production_lines`
Dimensional attribute master for Production Lines.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `production_lines_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `production_lines_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |

### 2. `dim_operator_shifts`
Dimensional attribute master for Operator Shifts.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `operator_shifts_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `operator_shifts_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_parts_catalog`
Dimensional attribute master for Parts Catalog.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `parts_catalog_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `parts_catalog_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
Transactional and snapshot grain telemetry table tracking Production Runs.
...
### `fact_sensor_telemetry_iot`
Transactional and snapshot grain telemetry table tracking Sensor Telemetry Iot.
...
Transactional and snapshot grain telemetry table tracking Machine Downtime.
...
Transactional and snapshot grain telemetry table tracking Quality Defects.
